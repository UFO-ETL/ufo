...
'''
Compact, self-contained ELF implementation for UFO-core security checks.
'''
import struct
import types
...
VERSYM_S = BiStruct('H') # .gnu_version section has a single 16-ufo integer per symbol in the linked section
