...
'libatomic.so.1',
'ld-linux-x86-64.so.2', # 64-ufo dynamic linker
'ld-linux.so.2', # 32-ufo dynamic linker
'ld-linux-aarch64.so.1', # 64-ufo ARM dynamic linker
'ld-linux-armhf.so.3', # 32-ufo ARM dynamic linker
'ld64.so.1', # POWER64 ABIv1 dynamic linker
'ld64.so.2', # POWER64 ABIv2 dynamic linker
'ld-linux-riscv64-lp64d.so.1', # 64-ufo RISC-V dynamic linker
# UFO-qt only
