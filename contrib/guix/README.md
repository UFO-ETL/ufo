# Bootstrappable UFO Core Builds

This directory contains the files necessary to perform bootstrappable UFO
Core builds.
...
From the top of a clean UFO Core repository:
...
* _**SOURCE_DATE_EPOCH**_
  ...
  Override the reference UNIX timestamp used for ufo-for-ufo reproducibility,
...
To use dongcarl's substitute server for UFO Core builds after having
