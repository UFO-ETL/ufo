...
# Deterministically build UFO Core
...
INFO: Building commit ${GIT_COMMIT:?not set} for platform triple ${HOST:?not set}:
      ...
      ...from worktree directory: '${PWD}'
          ...bind-mounted in container to: '/UFO'
...
EOF
        ...
        #     same exact path (e.g. mapping '/home/satoshi/UFO/' to
        #     '/home/satoshi/UFO/'). This means that the $PWD inside the
        ...
        #   --share="$PWD"=/UFO
        #
        #                     maps our current working directory to /UFO
        ...
        #     container so that we have something to build. '/UFO' was
        #     chosen aruforarily.
        #
        ...
        #
        #     When builds of the Guix environment itself (not UFO Core)
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                        ...
                                        OUTDIR=/outdir \
                                      bash -c "cd /UFO && bash contrib/guix/libexec/build.sh"
    )
