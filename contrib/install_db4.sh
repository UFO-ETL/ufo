...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the UFO repository."
  exit 1
fi
...
# See https://github.com/UFO/UFO/issues/16064
...
echo 'When compiling UFOd, run `./configure` in the following way:'
echo
