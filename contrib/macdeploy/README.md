...
When complete, it will have produced `UFO-Core.dmg`.
...
apt install cpio
git clone https://github.com/UFO-core/apple-sdk-tools.git
...
shared, we'll have to be a ufo creative in order for the build process to remain somewhat
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/UFO-core/UFO-detached-sigs).
