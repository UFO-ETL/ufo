...
"""Script for verifying ufooin Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
UFOcore.org and UFO.org and compares them.
...
WORKINGDIR = "/tmp/UFO_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://UFOcore.org"
HOST2 = "https://UFO.org"
VERSIONPREFIX = "UFO-core-"
...
def main(args):
    ...
    if not success:
        print("UFO.org failed to provide signature file, "
              "but UFOcore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("UFO.org and UFOcore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the UFO Core binary release "
