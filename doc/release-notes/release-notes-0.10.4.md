UFO Core version 0.10.4 is now available from:

  <https://UFO.org/bin/UFO-core-0.10.4/>
...
- #6953 `43c2789` Split UFO-tx into its own package
- #6953 `dfe0d4d` Include UFO-tx binary on Debian/Ubuntu
