UFO Core version 0.13.2 is now available from:

  <https://UFO.org/bin/UFO-core-0.13.2/>
...
- #8908 `4a974b2` Update UFO-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow UFO-tx to create v2 transactions (btcdrak)
