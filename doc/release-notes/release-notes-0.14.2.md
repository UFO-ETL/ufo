UFO Core version 0.14.2 is now available from:

  <https://UFO.org/bin/UFO-core-0.14.2/>
...
(in UFO Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate UFO-config.h as necessary (theuni)
