UFO Core version 0.16.1 is now available from:

  <https://UFOcore.org/bin/UFO-core-0.16.1/>
...
- #12843 `df38b13` Test starting UFOd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure UFOd processes are cleaned up when tests end (sdaftuar)
