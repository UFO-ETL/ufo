UFO Core version 0.16.3 is now available from:

  <https://UFOcore.org/bin/UFO-core-0.16.3/>
...
been discovered in UFO Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` UFOconsensus: invalid flags error should be set to `UFOconsensus_err` (afk11)
