...
UFO Core version 0.19.1 is now available from:

  <https://UFOcore.org/bin/UFO-core-0.19.1/>
...
From UFO Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as UFO Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, UFO Core does not yet change appearance when
...
- #17488 fix "UFOd already running" warnings on macOS (fanquake)
