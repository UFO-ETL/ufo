UFO-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/UFO/files/UFO/UFO-0.8.0/
...
by default, so looking up an aruforary transaction using the getrawtransaction
...
Mac and Windows binaries are signed with certificates owned by the UFO
...
New/changed settings (command-line or UFO.conf file)
--------------------------------------------------------
...
fix that makes it a little ufo more difficult for attackers to double-spend a
