UFO Core version 0.9.2.1 is now available from:

  https://UFO.org/bin/0.9.2.1/
...
been tested quite a ufo, there could be possible regressions. Be sure to report
...
- Add new DNS seed from ufonodes.io
...
- Changed uforpc.py's raw_input to getpass for passwords to conceal characters during command line input
