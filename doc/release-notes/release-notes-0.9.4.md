UFO Core version 0.9.4 is now available from:

  https://UFO.org/bin/0.9.4/
...
this update is incompatible with the UFO system and could lead to consensus
forks.

UFO Core released binaries from https://UFO.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~UFO/+archive/ubuntu/UFO
- A third-party or self-compiled UFO Core

upgrade to UFO Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
