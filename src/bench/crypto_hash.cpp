...
static void FastRandom_32ufo(benchmark::Bench& bench)
{
...
static void FastRandom_1ufo(benchmark::Bench& bench)
{
    FastRandomContext rng(true);
    bench.run([&] {
        rng.randbool();
...
BENCHMARK(FastRandom_32ufo);
BENCHMARK(FastRandom_1ufo);
