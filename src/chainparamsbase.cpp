...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-vbparams=deployment:start:end", "Use given start/end times for specified version ufos deployment (regtest-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CHAINPARAMS);
 ...
 * been chosen aruforarily to keep ranges of used ports tight.
 */
