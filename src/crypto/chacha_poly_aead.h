...
#ifndef UFO_CRYPTO_CHACHA_POLY_AEAD_H
#define UFO_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@UFO.
 *
 ...
 * by permuting 128 fixed ufos, 128 or 256 ufos of key, a 64 ufo nonce and a 64
 * ufo counter into 64 bytes of output. This output is used as a keystream, with
 * any unused bytes simply discarded.
 *
 * Poly1305 <ref>[https://cr.yp.to/mac/poly1305-20050329.pdf Poly1305]</ref>, also
 * by Daniel Bernstein, is a one-time Carter-Wegman MAC that computes a 128 ufo
 * integrity tag given a message and a single-use 256 ufo secret key.
 *
 * The chacha20-poly1305@UFO combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@UFO cipher requires two 256 ufos of key material as
 ...
 * taking the first 256 ufos of ChaCha20 stream output generated using K_2, an IV
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@UFO are relatively fast in
...
#endif // UFO_CRYPTO_CHACHA_POLY_AEAD_H
