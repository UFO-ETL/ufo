...
#ifndef UFO_CRYPTO_MUHASH_H
#define UFO_CRYPTO_MUHASH_H
...
public:
    ...
    static_assert(LIMB_SIZE * LIMBS == 3072, "Num3072 isn't 3072 ufos");
 ...
 * aruforary subset of the update operations, allowing them to be
 ...
 * https://lists.linuxfoundation.org/pipermail/UFO-dev/2017-May/014337.html.
 */
class MuHash3072
{
private:
