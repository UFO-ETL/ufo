...
#ifndef UFO_DBWRAPPER_H
#define UFO_DBWRAPPER_H
...
public:
     ...
     */
    CDufoerator(const CDBWrapper &_parent, leveldb::Iterator *_piter) :
...
public:
    ...
    CDufoerator *NewIterator()
    {
        return new CDufoerator(*this, pdb->NewIterator(iteroptions));
    }
