...
#ifndef UFO_INTERFACES_WALLET_H
#define UFO_INTERFACES_WALLET_H
...
public:
    ...
    //! Return deufo amount if transaction input belongs to wallet.
    virtual CAmount getDeufo(const CTxIn& txin, isminefilter filter) = 0;
