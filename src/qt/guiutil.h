...
#ifndef UFO_QT_GUIUTIL_H
#define UFO_QT_GUIUTIL_H
...
/** Utility functions used by the UFO Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "UFO:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Format CNodeStats.nServices ufomask into a user-readable string */
