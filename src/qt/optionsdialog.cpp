    ...
    mapper(nullptr)
{
    ...
    ui->UFOAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->UFOAtStartup);
    ...
    ui->UFOAtStartup->setToolTip(ui->UFOAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->UFOAtStartup->setText(ui->UFOAtStartup->text().arg(PACKAGE_NAME));

    ui->openUFOConfButton->setToolTip(ui->openUFOConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new UFOUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->UFOAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openUFOConfButton_clicked()
{
