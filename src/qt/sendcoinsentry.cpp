    ...
    platformStyle(_platformStyle)
{
    ...
    // normal UFO address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying UFO address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &UFOAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
