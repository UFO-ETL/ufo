...
//! Entry point for UFOApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &UFOApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for UFOGUI tests.
void AppTests::guiTests(UFOGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &UFOGUI::consoleShown, this, &AppTests::consoleTests);
