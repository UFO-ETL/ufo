...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const interfaces::WalletTx& wtx)
{
    ...
    else
    {
        ...
        if (fAllFromMe && fAllToMe)
        {
            ...
            parts.append(TransactionRecord(hash, nTime, TransactionRecord::SendToSelf, address, -(nDeufo - nChange), nCredit - nChange));
        ...
        {
            //
            // Mixed deufo transaction, can't break down payees
            //
