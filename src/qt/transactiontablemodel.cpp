...
{
    columns << QString() << QString() << tr("Date") << tr("Type") << tr("Label") << UFOUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
{
    columns[Amount] = UFOUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed, UFOUnits::SeparatorStyle separators) const
{
    QString str = UFOUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->credit + wtx->deufo, false, separators);
    if(showUnconfirmed)
    {
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DisplayRole:
        ...
        case Amount:
            return formatTxAmount(rec, true, UFOUnits::SeparatorStyle::ALWAYS);
        }
        break;
    case Qt::EditRole:
        ...
        case Amount:
            return qint64(rec->credit + rec->deufo);
        }
        break;
    case Qt::ToolTipRole:
    ...
    case Qt::ForegroundRole:
        ...
        if(index.column() == Amount && (rec->credit+rec->deufo) < 0)
        {
    ...
    case TxPlainTextRole:
        {
            ...
            details.append(formatTxAmount(rec, false, UFOUnits::SeparatorStyle::NEVER));
            return details;
        }
    case ConfirmedRole:
    ...
    case FormattedAmountRole:
        ...
        return formatTxAmount(rec, false, UFOUnits::SeparatorStyle::NEVER);
    case StatusRole:
