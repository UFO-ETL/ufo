...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, UFOGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &UFOGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &UFOGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &UFOGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &UFOGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &UFOGUI::updateWalletStatus);
    connect(gui, &UFOGUI::setPrivacy, walletView, &WalletView::setPrivacy);
