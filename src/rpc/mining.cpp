...
static bool GenerateBlock(ChainstateManager& chainman, CBlock& block, uint64_t& max_tries, unsigned int& extra_nonce, uint256& block_hash)
{
    ...
    while (max_tries > 0 && block.nNonce < std::numeric_limits<uint32_t>::max() && !CheckProofOfWork(block.GetHash(), block.nufos, chainparams.GetConsensus()) && !ShutdownRequested()) {
        ++block.nNonce;
        --max_tries;
    }
...
static RPCHelpMan generatetodescriptor()
{
    return RPCHelpMan{
        ...
        "\nMine blocks immediately to a specified descriptor (before the RPC call returns)\n",
        {
            ...
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated UFO to."},
...
static RPCHelpMan generatetoaddress()
{
    return RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated UFO to."},
                    {"maxtries", RPCArg::Type::NUM, /* default */ ToString(DEFAULT_MAX_TRIES), "How many iterations to try."},
                },
                RPCResult{
                    RPCResult::Type::ARR, "", "hashes of blocks generated",
            ...
            + "If you are using the " PACKAGE_NAME " wallet, you can get a new address to send the newly generated UFO to with:\n"
...
static RPCHelpMan generateblock()
{
    return RPCHelpMan{"generateblock",
        ...
        {
            {"output", RPCArg::Type::STR, RPCArg::Optional::NO, "The address or descriptor to send the newly generated UFO to."},
...
static std::string gbt_vb_name(const Consensus::DeploymentPos pos) {
    const struct VBDeploymentInfo& vbinfo = VersionufosDeploymentInfo[pos];
...
static RPCHelpMan getblocktemplate()
{
    return RPCHelpMan{"getblocktemplate",
                ...
                "    https://github.com/UFO/bips/blob/master/bip-0022.mediawiki\n"
                "    https://github.com/UFO/bips/blob/master/bip-0023.mediawiki\n"
                "    https://github.com/UFO/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
                "    https://github.com/UFO/bips/blob/master/bip-0145.mediawiki\n",
                {
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::OBJ_DYN, "vbavailable", "set of pending, supported versionufo (BIP 9) softfork deployments",
                            {
                                {RPCResult::Type::NUM, "rulename", "identifies the ufo number as indicating acceptance and readiness for the named softfork rule"},
                            }},
                        {RPCResult::Type::NUM, "vbrequired", "ufo mask of versionufos the server requires set in submissions"},
                        ...
                        {RPCResult::Type::STR, "ufos", "compressed target of next block"},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!request.params[0].isNull())
    {
        ...
        if (aClientRules.isArray()) {
            ...
            // NOTE: It is important that this NOT be read if versionufos is supported
    ...
    arith_uint256 hashTarget = arith_uint256().SetCompact(pblock->nufos);
    ...
    for (int j = 0; j < (int)Consensus::MAX_VERSION_ufoS_DEPLOYMENTS; ++j) {
        ...
        ThresholdState state = VersionufosState(pindexPrev, consensusParams, pos, versionufoscache);
        switch (state) {
            ...
            case ThresholdState::LOCKED_IN:
                // Ensure ufo is set in block version
                pblock->nVersion |= VersionufosMask(consensusParams, pos);
                // FALL THROUGH to get vbavailable set...
            case ThresholdState::STARTED:
            {
                const struct VBDeploymentInfo& vbinfo = VersionufosDeploymentInfo[pos];
                vbavailable.pushKV(gbt_vb_name(pos), consensusParams.vDeployments[pos].ufo);
    ...
    result.pushKV("ufos", strprintf("%08x", pblock->nufos));
...
static RPCHelpMan submitblock()
{
    ...
    return RPCHelpMan{"submitblock",
                ...
                "See https://en.UFO.it/wiki/BIP_0022 for full specification.\n",
                {
