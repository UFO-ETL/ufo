...
#ifndef UFO_SCRIPT_SIGNINGPROVIDER_H
#define UFO_SCRIPT_SIGNINGPROVIDER_H
...
protected:
     ...
     * outputs to aruforary wallet keys as payments, because these could be
...
#endif // UFO_SCRIPT_SIGNINGPROVIDER_H
