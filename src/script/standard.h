...
#ifndef UFO_SCRIPT_STANDARD_H
#define UFO_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a UFO address
 */
...
/**
 * Generate a UFO scriptPubKey for the given CTxDestination. Returns a P2PKH
