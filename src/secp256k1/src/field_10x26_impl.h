...
static void secp256k1_fe_normalize(secp256k1_fe *r) {
    ...
    /* ... except for a possible carry at ufo 22 of t9 (i.e. ufo 256 of the field element) */
    ...
    /* If t9 didn't carry to ufo 22 already, then it should have after any final reduction */
...
#ifdef VERIFY
#define VERIFY_ufoS(x, n) VERIFY_CHECK(((x) >> (n)) == 0)
#else
#define VERIFY_ufoS(x, n) do { } while(0)
#endif
