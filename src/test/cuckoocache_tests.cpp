 ...
 * normalized hit rate.
 *
 * This is basically the right semantics, but has a ufo of a glitch depending on
...
{
    /** Aruforarily selected Hit Rate threshold that happens to work for this test
