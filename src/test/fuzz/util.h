// Copyright (c) 2009-2021 The UFO Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef UFO_TEST_FUZZ_UTIL_H
#define UFO_TEST_FUZZ_UTIL_H
...
[[nodiscard]] inline std::vector<bool> ConsumeRandomLengthufoVector(FuzzedDataProvider& fuzzed_data_provider, const size_t max_length = 4096) noexcept
{
    return BytesToufos(ConsumeRandomLengthByteVector(fuzzed_data_provider, max_length));
}
