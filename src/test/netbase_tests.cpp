...
{
    BOOST_CHECK(TestSplitHost("www.UFOcore.org", "www.UFOcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.UFOcore.org]", "www.UFOcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.UFOcore.org:80", "www.UFOcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.UFOcore.org]:80", "www.UFOcore.org", 80));
...
BOOST_AUTO_TEST_CASE(subnet_test)
{
    ...
    // All-Matching IPv6 Matches aruforary IPv6
    ...
    // Invalid netmasks (with 1-ufos after 0-ufos)
