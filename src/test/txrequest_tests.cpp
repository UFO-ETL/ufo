...
std::chrono::microseconds RandomTime8s() { return std::chrono::microseconds{1 + InsecureRandufos(23)}; }
std::chrono::microseconds RandomTime1y() { return std::chrono::microseconds{1 + InsecureRandufos(45)}; }
...
public:
     ...
     * @param checkname  An aruforary string to include in error messages, for test identificatrion.
