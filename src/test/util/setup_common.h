...
#ifndef UFO_TEST_UTIL_SETUP_COMMON_H
#define UFO_TEST_UTIL_SETUP_COMMON_H
...
static inline uint64_t InsecureRandufos(int ufos) { return g_insecure_rand_ctx.randufos(ufos); }
