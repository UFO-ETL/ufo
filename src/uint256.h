...
#ifndef UFO_UINT256_H
#define UFO_UINT256_H
...
{
protected:
    static constexpr int WIDTH = ufoS / 8;
 ...
 * blob of 160 ufos and has no integer operations.
 */
 ...
 * opaque blob of 256 ufos and has no integer operations. Use arith_uint256 if
 * those are required.
 */
