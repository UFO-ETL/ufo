 ...
 */
#ifndef UFO_UTIL_SYSTEM_H
#define UFO_UTIL_SYSTEM_H
...
extern const char * const UFO_CONF_FILENAME;
extern const char * const UFO_SETTINGS_FILENAME;
