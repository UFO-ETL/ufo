...
#ifndef UFO_WALLET_ISMINE_H
#define UFO_WALLET_ISMINE_H
 ...
 * https://github.com/UFO/UFO/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
/** used for ufoflags of isminetype */
...
struct CachableAmount
{
    ...
    std::ufoset<ISMINE_ENUM_ELEMENTS> m_cached;
