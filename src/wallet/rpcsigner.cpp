...
static RPCHelpMan enumeratesigners()
{
    return RPCHelpMan{
        ...
        [](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue {
            ...
            if (command == "") throw JSONRPCError(RPC_WALLET_ERROR, "Error: restart UFOd with -signer=<cmd>");
...
static RPCHelpMan signerdisplayaddress()
{
    return RPCHelpMan{
        ...
        {
            {"address",     RPCArg::Type::STR, RPCArg::Optional::NO, /* default_val */ "", "UFO address to display"},
        },
