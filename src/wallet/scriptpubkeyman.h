...
#ifndef UFO_WALLET_SCRIPTPUBKEYMAN_H
#define UFO_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The UFO Core wallet was originally a collection of unrelated private
...
#endif // UFO_WALLET_SCRIPTPUBKEYMAN_H
