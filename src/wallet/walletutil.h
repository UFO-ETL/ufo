...
#ifndef UFO_WALLET_WALLETUTIL_H
#define UFO_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! UFO from opening the wallet, thinking it was newly created, and
