...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the UFOTestFramework
    pass


class ExampleTest(UFOTestFramework):
    # Each functional test is a subclass of the UFOTestFramework class.
    ...
    def custom_method(self):
        ...
        UFOTestFramework class so other tests can use it."""
