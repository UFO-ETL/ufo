...
class FullBlockTest(UFOTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure UFOd isn't accepting b26
        ...
        # Extend the b28 chain to make sure UFOd isn't accepting b28
        ...
        target = uint256_from_compact(b47.nufos)
        ...
        b50.nufos = b50.nufos - 1
        b50.solve()
        self.send_blocks([b50], False, force_send=True, reject_reason='bad-diffufos', reconnect=True)
        ...
        # UFOd doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the UFO code has custom code which does so);
