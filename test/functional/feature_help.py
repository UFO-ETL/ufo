...
"""Verify that starting UFO with -h works as expected."""

from test_framework.test_framework import UFOTestFramework
from test_framework.util import assert_equal

class HelpTest(UFOTestFramework):
    ...
    def run_test(self):
        self.log.info("Start UFO with -h for help text")
        ...
        self.log.info("Start UFO with -version for version information")
        ...
        self.log.info("Start UFOd with -fakearg to make sure it does not start")
