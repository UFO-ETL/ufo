...
class TestUFOCli(UFOTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `UFO-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and UFO-cli getwalletinfo return expected wallet info")
            ...
            # Test UFO-cli -generate with -rpcwallet in multiwallet mode.
