...
class RESTTest (UFOTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Mine blocks and send UFO to node 1")
        ...
        # Check ufomap
        assert_equal(json_obj['ufomap'], "0")
        ...
        assert_equal(len(json_obj['utxos']), 1)
        assert_equal(json_obj['ufomap'], "10")
        ...
        for key in ['hash', 'confirmations', 'height', 'version', 'merkleroot', 'time', 'nonce', 'ufos', 'difficulty', 'chainwork', 'previousblockhash']:
