...
By default, UFOd will dump mempool on shutdown and
...
class MempoolPersistTest(UFOTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent UFOd from writing mempool.dat to disk. Verify that `savemempool` fails")
