...
VERSIONufoS_TOP_ufoS = 0x20000000
VERSIONufoS_DEPLOYMENT_TESTDUMMY_ufo = 28
...
class MiningTest(UFOTestFramework):
    ...
    def mine_chain(self):
        ...
        self.connect_nodes(0, 1)
        assert_equal(VERSIONufoS_TOP_ufoS + (1 << VERSIONufoS_DEPLOYMENT_TESTDUMMY_ufo), self.nodes[0].getblocktemplate(NORMAL_GBT_REQUEST_PARAMS)['version'])
        self.restart_node(0)
        self.connect_nodes(0, 1)
    ...
    def run_test(self):
        ...
        self.log.info("getblocktemplate: Test bad ufos")
        bad_block = copy.deepcopy(block)
        bad_block.nufos = 469762303  # impossible in the real world
        assert_template(node, bad_block, 'bad-diffufos')
