...
class InvalidMessagesTest(UFOTestFramework):
    ...
    def test_buffer(self):
        ...
        cut_pos = 12  # Chosen at an aruforary position within the header
    ...
    def test_addrv2(self, label, required_log_messages, raw_addrv2):
        ...
        # Make sure UFOd signals support for ADDRv2, otherwise this test
