...
class P2PPermissionsTests(UFOTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].UFOconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].UFOconf, 'w', encoding="utf8") as f:
            f.write(newText)
