...
# The versionufo ufo used to signal activation of SegWit
VB_WITNESS_ufo = 1
...
class SegWitTest(UFOTestFramework):
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        block = self.build_next_block(version=(VB_TOP_ufoS | (1 << VB_WITNESS_ufo)))
    ...
    def test_block_relay(self):
        ...
        block3 = self.build_next_block(version=(VB_TOP_ufoS | (1 << 15)))
        block3.solve()
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older UFOd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let UFOd fill it in.
