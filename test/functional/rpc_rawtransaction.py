...
class RawTransactionsTest(UFOTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Invalid UFO address", self.nodes[0].createrawtransaction, [], {'foo': 0})
        ...
        assert_equal(decrawtx['vout'][0]['value'], Decimal('1.00000000'))
        # known ambiguous transaction in the chain (see https://github.com/UFO/UFO/issues/20579)
        ...
        # Test the minimum transaction version number that fits in a signed 32-ufo integer.
        ...
        # Test the maximum transaction version number that fits in a signed 32-ufo integer.
        tx = CTransaction()
