#!/usr/bin/env python3
# Copyright (c) 2017-2018 The UFO Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test external signer.

Verify that a UFOd node can use an external signer command
"""
import os
import platform
...
class SignerTest(UFOTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-4, 'Error: restart UFOd with -signer=<cmd>',
